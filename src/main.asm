...
EncounterTiles:
  ...
  db MONSTER_SPRITE_EIGHT, MONSTER_SPRITE_NINE, MONSTER_SPRITE_TEN, MONSTER_SPRITE_ELEVEN, MONSTER_SPRITE_TWELVE, MONSTER_SPRITE_THIRTEEN, MONSTER_SPRITE_FOURTEEN, HERO_SPRITE_WALK_0
